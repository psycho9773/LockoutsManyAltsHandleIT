...
--  Abreviations  "TWW", "DF", "SL", "BFA", "LGN", "WOD", "MOP", "CAT", "WLK", "TBC", "WOW"
    ...
    LMAHI.lockoutData.dungeons = {
     { id = 2549, name = "The Rookery", reset = "daily", expansion = "TWW" },
		...
		{ id = 756, name = "The Deadmines (H)", reset = "daily", expansion = "CAT" },
		{ id = 764, name = "Shadowfang Keep (H)", reset = "daily", expansion = "CAT" },
    ...
    LMAHI.lockoutData.quests = {
        { id = 86775, name = "Urge to Surge", reset = "weekly", expansion = "TWW" },
        { id = 85879, name = "Reduce, Reuse, Resell", reset = "weekly", expansion = "TWW" },
        { id = 85869, name = "Many Jobs, Handle It!", reset = "weekly", expansion = "TWW" },
        { id = 85088, name = "The Main Event - The Gobfather", reset = "weekly", expansion = "TWW" },
    }

    -- Rares
    LMAHI.lockoutData.rares = {
        { id = 90488, name = "M.A.G.N.O.", reset = "weekly", expansion = "TWW" },
        { id = 90489, name = "Giovante", reset = "weekly", expansion = "TWW" },
        { id = 90490, name = "Voltstrike the Charged", reset = "weekly", expansion = "TWW" },
        { id = 90491, name = "Scrapchewer", reset = "weekly", expansion = "TWW" },
        { id = 90492, name = "Darkfuse Precipitant", reset = "weekly", expansion = "TWW" },
        { id = 84877, name = "Ephemeral Agent Lathyd", reset = "weekly", expansion = "TWW" },
        { id = 84895, name = "Slugger the Smart", reset = "weekly", expansion = "TWW" },
        { id = 84907, name = "Chief Foreman Gutso", reset = "weekly", expansion = "TWW" },
        { id = 84884, name = "The Junk-Wall", reset = "weekly", expansion = "TWW" },
        { id = 84911, name = "Flyboy Snooty", reset = "weekly", expansion = "TWW" },
        { id = 87007, name = "Gallagio Garbage", reset = "daily", expansion = "TWW" },
        { id = 84927, name = "Candy Stickemup", reset = "daily", expansion = "TWW" },
        { id = 84928, name = "Grimewick", reset = "daily", expansion = "TWW" },
        { id = 84919, name = "Tally Doublespeak", reset = "daily", expansion = "TWW" },
        { id = 84920, name = "V.V. Goosworth", reset = "daily", expansion = "TWW" },
        { id = 84917, name = "Scrapbeak", reset = "daily", expansion = "TWW" },
        { id = 84926, name = "Nitro", reset = "daily", expansion = "TWW" },
        { id = 85004, name = "Swigs Farsight", reset = "daily", expansion = "TWW" },
        { id = 84921, name = "Thwack", reset = "daily", expansion = "TWW" },
        { id = 84922, name = "S.A.L.", reset = "daily", expansion = "TWW" },
        { id = 84918, name = "Ratspit", reset = "daily", expansion = "TWW" },
    }

    -- Currencies
    LMAHI.lockoutData.currencies = {
        { id = 1166, name = "Timewarped Badge", max = 500, reset = "weekly", expansion = "TWW" },
        { id = 1828, name = "Valorstones", max = 2000, reset = "weekly", expansion = "TWW" },
        { id = 3008, name = "Resonance Crystals", max = 1000, reset = "weekly", expansion = "TWW" },
    }
