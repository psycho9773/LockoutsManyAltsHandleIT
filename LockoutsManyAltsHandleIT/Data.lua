...
--  Abreviations  "TWW", "DF", "SL", "BFA", "LGN", "WOD", "MOP", "CAT", "WLK", "TBC", "WOW"
    ...
    LMAHI.lockoutData.quests = {
		...
		{ id = 90124, name = "11.2  Eliminate Shatterpulse", reset = "weekly", expansion = "TWW" },
		{ id = 90126, name = "11.2  Eliminate Grubber", reset = "weekly", expansion = "TWW" },
		{ id = 90127, name = "11.2  Eliminate Arcana-Monger So'zer", reset = "weekly", expansion = "TWW" },
		{ id = 83432, name = "11.2  The Rookery", reset = "weekly", expansion = "TWW" },--Move these up
		{ id = 83457, name = "11.2  The Stonevault", reset = "weekly", expansion = "TWW" },
		{ id = 83458, name = "11.2  Priory of the Sacred Flame", reset = "weekly", expansion = "TWW" },
		{ id = 83469, name = "11.2  City of Threads", reset = "weekly", expansion = "TWW" },
		{ id = 83436, name = "11.2  Cinderbrew Meadery", reset = "weekly", expansion = "TWW" },
		{ id = 83443, name = "11.2  Darkflame Cleft", reset = "weekly", expansion = "TWW" },				
		{ id = 83459, name = "11.2  The Dawnbreaker", reset = "weekly", expansion = "TWW" },
		{ id = 83465, name = "11.2  Ara-Kara, City of Echoes", reset = "weekly", expansion = "TWW" },		
		{ id = 86203, name = "11.2  Operation: Floodgate", reset = "weekly", expansion = "TWW" },
		--not in yet?{ id = 86203, name = "11.2  Eco-Dome Al'dani", reset = "weekly", expansion = "TWW" },
		{ id = 82706, name = "11.2  Delves: Worldwide Research", reset = "weekly", expansion = "TWW" },
		
		--PVP		
		{ id = 47148, name = " PvP Something Different", reset = "weekly", expansion = "TWW" },
		{ id = 80184, name = " PvP Preserving in Battle", reset = "weekly", expansion = "TWW" },
		{ id = 80185, name = " PvP Preserving Solo", reset = "weekly", expansion = "TWW" },
		{ id = 80186, name = " PvP Preserving in War", reset = "weekly", expansion = "TWW" },
		{ id = 80187, name = " PvP Preserving in Skirmishes", reset = "weekly", expansion = "TWW" },
		{ id = 80188, name = " PvP Preserving in Arenas", reset = "weekly", expansion = "TWW" },
		{ id = 80189, name = " PvP Preserving Teamwork", reset = "weekly", expansion = "TWW" },
		{ id = 81793, name = " PvP Sparks of War: Isle of Dorn", reset = "weekly", expansion = "TWW" },
		{ id = 81794, name = " PvP Sparks of War: The Ringing Deeps", reset = "weekly", expansion = "TWW" },
		{ id = 81795, name = " PvP Sparks of War: Hallowfall", reset = "weekly", expansion = "TWW" },
		{ id = 81796, name = " PvP Sparks of War: Azj-Kahet", reset = "weekly", expansion = "TWW" },
		{ id = 90781, name = " PvP Sparks of War: K'aresh", reset = "weekly", expansion = "TWW" },
		...
		{ id = 83333, name = "11.0  Gearing Up for Trouble", reset = "weekly", expansion = "TWW" },
		{ id = 82946, name = "11.0  Rollin' Down in the Deeps", reset = "weekly", expansion = "TWW" },
		{ id = 83240, name = "11.0  The Theater Troupe", reset = "weekly", expansion = "TWW" },
		{ id = 82449, name = "11.0  The Call of the Worldsoul", reset = "weekly", expansion = "TWW" },
		
		--Profession Weeklies
		{ id = 84127, name = "11.0  Blacksmithing Services Requested", reset = "weekly", expansion = "TWW" },
		{ id = 84128, name = "11.0  Engineering Services Requested", reset = "weekly", expansion = "TWW" },
		{ id = 84129, name = "11.0  Inscription Services Requested", reset = "weekly", expansion = "TWW" },
		{ id = 84130, name = "11.0  Jewelcrafting Services Requested", reset = "weekly", expansion = "TWW" },
		{ id = 84131, name = "11.0  Leatherworking Services Requested", reset = "weekly", expansion = "TWW" },
		{ id = 84132, name = "11.0  Tailoring Services Requested", reset = "weekly", expansion = "TWW" },
		{ id = 84133, name = "11.0  Alchemy Services Requested", reset = "weekly", expansion = "TWW" },
		--Mining Weeklies
		{ id = 83103, name = "11.0  Acquiring Aqirite", reset = "weekly", expansion = "TWW" },
		{ id = 83102, name = "11.0  Bismuth is Business", reset = "weekly", expansion = "TWW" },
		{ id = 83104, name = "11.0  Identifying Ironclaw", reset = "weekly", expansion = "TWW" },
		{ id = 83106, name = "11.0  Null Pebble Excavation", reset = "weekly", expansion = "TWW" },
		{ id = 83105, name = "11.0  Rush-order Requisition", reset = "weekly", expansion = "TWW" },
		--Herbalism Weeklies
		{ id = 82970, name = "11.0  A Bloom and a Blossom", reset = "weekly", expansion = "TWW" },
		{ id = 82962, name = "11.0  A Handful of Luredrops", reset = "weekly", expansion = "TWW" },
		{ id = 82965, name = "11.0  Light and Shadow", reset = "weekly", expansion = "TWW" },
		{ id = 82958, name = "11.0  Little Blessings", reset = "weekly", expansion = "TWW" },
		{ id = 82916, name = "11.0  When Fungi Bloom", reset = "weekly", expansion = "TWW" },
    }
